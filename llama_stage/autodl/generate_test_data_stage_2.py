...
for set_name in ['val', 'test']:
    ...
    embeddings_path = f'/root/autodl-tmp/crystal-llm-retrieval/embeddings/embeddings_{set_name}.csv'
    embeddings_df = pd.read_csv(embeddings_path, index_col=0)

    prediction_path = f'/root/autodl-tmp/llama-factory/mp_{set_name}_prediction_llama2_1/generated_predictions.jsonl'
    ...
    with open(f"/root/research/LLaMA-Factory/data/mp_{set_name}_stage_2.json", "w") as f:
