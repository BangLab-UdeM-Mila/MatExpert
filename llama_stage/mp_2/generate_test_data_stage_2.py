...
for set_name in ['val', 'test']:
    ...
    prediction_path = f'/data/rech/dingqian/intel/llama-factory/{MODEL_NAME}_{set_name}_prediction/generated_predictions.jsonl'
    ...
    with open(f"/u/dingqian/intel/LLaMA-Factory/data/{MODEL_NAME}_{set_name}_stage_2.json", "w") as f:
